...
echo "\n\r\t" . '<meta name="application-name" content="Mexican Baker"/>';
echo "\n\r\t" . '<meta name="msapplication-TileColor" content="#88B8B2"/>';
echo "\n\r\t" . '<meta name="msapplication-TileImage" content="/images/windowsTile.png"/>';
echo "\n\r\t<title>" . $pagetitle . "</title>";
